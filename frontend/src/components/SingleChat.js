      ...
      selectedChat?(
        <>
          ...
          >
             ...
             {isTyping ? 
             <div>
             <Lottie animationData={animationData} loop={true} style={{ marginBottom: 15, marginLeft: 0,height:50,width:70 }} />
              </div>
             :<></>
             }
        ...
        <Box display='flex' alignItems='center' justifyContent='center' h='100%'>
            <Text fontSize='3xl' pb={3} font-family='work sans'>
            Chat on a user to start chatting</Text>
        </Box>
      )
    }
  </>
